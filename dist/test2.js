...
(function (global, factory) {
    ...
    */
    ...
    createStandardXHR;
    console.log("wil jQuery", jQuery.ajaxSettings);
    var xhrId = 0,
        xhrCallbacks = {},
    ...
    console.log("wil xhrSupported", xhrSupported);
    ...
    function createStandardXHR() {
        ...
        console.log("fsfsdf", j);
        return j;
    }

    function createActiveXHR() {
        var j = new window.ActiveXObject("Microsoft.XMLHTTP");
        console.log("fsfsdf2", j);
        return j;
    }
